"""
Setup configuration for Amazon Quick Sight Backup Tool.
"""
...
def read_readme():
    ...
    if os.path.exists(readme_path):
        with open(readme_path, 'r', encoding='utf-8') as f:
            return f.read()
    return "Amazon Quick Sight Backup Tool - A comprehensive backup solution for Amazon Quick Sight resources."
